    ...
    <section className="bg-gray-100 py-20">
      <div className="md:max-w-[70%] mx-auto">
        ...
        <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
          <div className="">
            {/* <h3 className="md:text-3xl text-3xl font-bold text-gray-800 mb-10">
              Déjanos tus datos y encontremos la solución ideal para tu proyecto.
            </h3> */}
            <p className="flex items-center gap-2 text-lg text-gray-800 mb-2">
          ...
          <div className="">
            <section className="bg-white rounded-lg shadow-xl text-black body-font relative  p-5">
